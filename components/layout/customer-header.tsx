...
import { Menu, ShoppingBag, X, Pizza } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-14 items-center justify-between px-4 sm:h-16">
          <Link href="/" className="flex min-w-0 items-center gap-2.5 font-bold">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-verdec-yellow text-white">
              <Pizza className="h-5 w-5" />
            </div>
            <span className="truncate font-display text-lg italic sm:text-xl">{restaurantName}</span>
          </Link>
